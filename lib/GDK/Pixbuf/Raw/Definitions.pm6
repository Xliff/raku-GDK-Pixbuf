...
class GdkPixbufSimpleAnim     is repr<CPointer> is export does GLib::Roles::Pointers { }
class GdkPixbufSimpleAnimIter is repr<CPointer> is export does GLib::Roles::Pointers { }
